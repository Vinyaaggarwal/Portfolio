...
const projects = [
  {
    ...
    demoVideo: null,
    screens: [
      { label: 'Webcam Tracking', grad: 'from-slate-900 to-emerald-950', img: '/screenshots/webcam1.png' },
      { label: 'Real-Time Webcam', grad: 'from-slate-900 to-emerald-950', img: '/screenshots/webcam2.png' },
      { label: 'Image Detection', grad: 'from-slate-900 to-emerald-950', img: '/screenshots/upload_images1.png' },
      { label: 'Multi-Object Detection', grad: 'from-slate-900 to-emerald-950', img: '/screenshots/upload_images2.png' },
      { label: 'Video Stream', grad: 'from-emerald-950 to-slate-900', img: '/screenshots/upload_videos1.png' },
      { label: 'Video Analytics', grad: 'from-emerald-950 to-slate-900', img: '/screenshots/upload_videos2.png' },
    ],
  },
  {
    id: 2,
    ...
    demoVideo: null,
    screens: [
      { label: 'Main Feed', grad: 'from-slate-900 to-purple-950', img: '/screenshots/home.png' },
      { label: 'Recommendations', grad: 'from-purple-950 to-slate-900', img: '/screenshots/recommendations.png' },
      { label: 'Analytics', grad: 'from-purple-950 to-slate-900', img: '/screenshots/analytics.png' },
    ],
  },
  {
    id: 3,
