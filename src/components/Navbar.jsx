  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'glass border-b border-white/5 shadow-lg shadow-purple-500/5' : ''
          }`}
      >
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <MagneticButton radius={70} strength={0.4}>
              <motion.a
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium text-white border border-purple-500/50 hover:border-purple-400 hover:bg-purple-500/10 transition-all duration-300 inline-block"
              >
                Hire Me
              </motion.a>
            </MagneticButton>
