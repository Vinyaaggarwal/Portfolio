...
const skillCategories = [
  ...
  },
  {
    ...
    color: 'from-secondary-accent to-emerald-700',
...
const SkillChip = ({ skill }) => (
  <motion.span
    ...
    className="px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider text-text-secondary bg-white/5 border border-border-subtle hover:border-primary/40 hover:text-text-primary transition-all duration-200 cursor-default"
  >
    {skill}
  </motion.span>
);
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <motion.p variants={fadeUp} className="text-text-secondary max-w-xl mx-auto text-sm leading-relaxed px-4">
              A comprehensive toolkit for engineering robust digital experiences and intelligent systems.
            </motion.p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {skillCategories.map((cat) => (
              <motion.div
                ...
                className="group relative w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.33%-16px)] xl:w-[calc(25%-18px)] glass rounded-2xl p-6 border border-border-subtle hover:border-primary/30 transition-all duration-300 flex flex-col"
              >
                {/* Glow Effect */}
